...
interface CenterTestimonialProps {
  topHeader?: string;
  topHeaderBg?: string;
  heading?: string;
  subheading?: string;
...
export default function CenterTestimonial({
  topHeader = "Testimonials",
  topHeaderBg = "bg-linear-to-r from-[#B1FFE7] to-[#80FFD7]",
  heading = "What clients say",
  subheading = "Hear from the teams we've worked with",
  testimonials,
  primaryColor = "#2563EB",
  backgroundColor = "#FFFFFF",
}: CenterTestimonialProps) {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <p className={`text-center text-base font-semibold w-36 mx-auto rounded-4xl py-2 ${topHeaderBg}`}>{topHeader}</p>
          <h2 className="text-4xl lg:text-[60px] font-semibold mb-2 text-center">
            {heading}
          </h2>
          <p className="text-gray-600 text-lg text-center">{subheading}</p>
        </div>
